    ...
    <footer className='bg-gray-900 text-gray-200 py-10'>
        <div className='max-w-7xl mx-auto px-4 md:flex md:justify-between'>
            ...
            <div className='mb-6 md:mb-0'>
                <Link to='/'>
                <img src="Ecomm.png" alt="" className='w-32' />
                </Link>
                ...
                <p className='text-sm'>Email: Support@Zaptaro.com</p>
        ...
        <div>
            ...
            <form action="" className='mt-4 flex'>
                ...
                className='w-full p-2 rounded-1-md bg-white text-gray-500 focus:outline-none
                focus:ring-2 focus:ring-gray-50'
                />
        ...
        <div className='mt-8 border-t border-gray-700 pt-6 text-center text-sm'>
            <p>&copy; {new Date().getFullYear()} <span className='text-pink-600'>Ecomm</span>. All rights reserved</p>
        </div>
    </footer>
  )
}
